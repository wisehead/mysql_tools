...
-DCMAKE_CXX_FLAGS_RELEASE="-O3 -DNDEBUG -DDBUG_OFF -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -Wno-error -Wno-unused-variable -Wno-unused-parameter -gdwarf-2 -std=c++1z -fno-sized-deallocation"
2>&1 | tee -a ${build_log}
